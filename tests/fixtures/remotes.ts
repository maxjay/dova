...
export const remotes = {
  ...
  httpsLegacy: 'https://contoso.visualstudio.com/MyProject/_git/my-repo',
  httpsLegacyDefaultCollection: 'https://contoso.visualstudio.com/DefaultCollection/MyProject/_git/my-repo',
  sshLegacy: 'contoso@vs-ssh.visualstudio.com:v3/contoso/MyProject/my-repo',
...
export const orgUrls = {
  ...
  legacy: 'https://contoso.visualstudio.com',
};
