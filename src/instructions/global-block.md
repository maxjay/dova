...
Without `dova link`, `pr create` falls back to `#id` references in
commit messages; with neither, the PR is created **successfully with
nothing attached and no error**.
